...
namespace ProjectAI.Network
{
    ...
    {
        private const int MAX_PLAYERS = 4; // 호스트 포함 최대 인원
        private const int SHUTDOWN_TIMEOUT_MS = 3000; // 셧다운 대기 타임아웃 (밀리초)
